...
export default function Faq() {
    ...
    const faqData = [
        ...
        },
        {
            ...
            answer: "Большинство наших агентов по недвижимости выходят на первую сделку под конец первого или на начало второго месяца. В недвижимости это очень хороший результат, ведь продажа квартиры – не быстрая сделка. Мы достигаем таких результатов за счет качественного обучения."
        },
        {
        ...
        },
        {
            ...
            answer: "Вознаграждение за услуги агента составляет до 70% от суммы вознаграждения заказчика услуг. Средний доход агента по недвижимости – 200 000 рублей."
        }
    ];    
